...
| Average length of streak (success) | `1.555 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=1%2C+1%2C+1%2C+1%2C+1%2C+2%2C+1%2C+5%2C+1&x=41&y=21 !-->
...
| Total repository scans | `14,745` |
| Full success % | `004.35%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `052.17%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `056.52%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.01%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `043.47%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `21 (2023, Monday, July 24th at 02:37 pm PST)`

**Line count (including blank lines and compiler line):** `2,407`

**Word count:** `25,462`

**Character count (including spaces):** `169,857`

**Character count (excluding spaces):** `146,700`

**Size (in bytes):** `169,857`
