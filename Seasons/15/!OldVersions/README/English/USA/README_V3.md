...
| Partial success % | `040.00%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
...
**File version:** `3 (2023, Monday, September 11th at 04:05 pm PST)`

**Line count (including blank lines and compiler line):** `1,177`

**Word count:** `12,166`

**Character count (including spaces):** `82,390`

**Character count (excluding spaces):** `70,965`

**Size (in bytes):** `82,390`
