...
| Average length of streak (success) | `4.0 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=1%2C+7%0D%0A&x=40&y=18 !-->
...
| Total repository scans | `12,814` |
| Full success % | `022.22%` |
| Partial success % | `066.66%` |
| Overall success % | `088.88%` |
| Success % Margin of error | `00.01%` |
| Overall failure % | `011.11%` |
...
**File version:** `6 (2023, Wednesday, May 10th at 3:02 pm PST)`
