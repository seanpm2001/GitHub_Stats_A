...
| Average length of streak (success) | `5.500 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=1%2C+11%2C+9%2C+1&x=41&y=6 !-->
...
| Total repository scans | `36,484` |
| Full success % | `021.42%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `057.14%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `078.57%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.01%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `021.42%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `24 (2023, Monday, May 29th at 12:31 pm PST)`

**Line count (including blank lines and compiler line):** `2,704`
