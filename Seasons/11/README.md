...
| Average length of streak (success) | `4.33 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=1%2C+11%2C+1&x=70&y=28 !-->
| Average length of streak (failure) | `2.00 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=1%2C+3&x=50&y=21 !-->
| Total repository scans | `20,427` |
| Full success % | `017.64%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `058.82%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `076.47%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.01%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `023.52%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `14 (2023, Thursday, May 18th at 1:41 pm PST)`

**Line count (including blank lines and compiler line):** `1,860`
