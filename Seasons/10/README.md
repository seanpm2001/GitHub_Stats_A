...
| Full success % | `030.00%` |
| Partial success % | `040.00%` |
| Overall success % | `070.00%` |
| Success % Margin of error | `00.00%` |
| Overall failure % | `030.00%` |
...
**File version:** `10 (2023, Friday, April 21st at 2:27 pm PST)`

**Line count (including blank lines and compiler line):** `1,622`
