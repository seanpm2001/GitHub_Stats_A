...
| Average length of streak (success) | `2.333 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=5%2C+3%2C+2%2C+1%2C+1%2C+2&x=33&y=11 !-->
...
| Total repository scans | `14,623` |
| Full success % | `004.54%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `059.09%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `063.63%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `036.36%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `20 (2023, Wednesday, August 23rd at 03:07 pm PST)`

**Line count (including blank lines and compiler line):** `2,376`

**Word count:** `24,271`

**Character count (including spaces):** `164,961`

**Character count (excluding spaces):** `142,530`

**Size (in bytes):** `164,961`
