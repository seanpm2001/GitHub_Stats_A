...
| Average length of streak (success) | `2.750 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=5%2C+3%2C+2%2C+1&x=38&y=21 !-->
...
| Overall success % | `073.33%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `026.67%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `14 (2023, Wednesday, August 16th at 03:25 pm PST)`

**Line count (including blank lines and compiler line):** `1,737`

**Word count:** `17,214`

**Character count (including spaces):** `117,070`

**Character count (excluding spaces):** `101,040`

**Size (in bytes):** `117,070`
