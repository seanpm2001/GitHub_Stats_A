...
| Full success (days) | `4` |
| Partial success (days) | `12` |
| Failure rate (days) | `2` |
| Days passed in season | `18` |
...
| Average length of streak (success) | `5.333 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=7%2C+6%2C+3&x=44&y=28 !-->
...
| Total repository scans | `26,274` |
| Full success % | `022.22%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `066.67%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `088.89%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `011.11%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `19 (2023, Monday, June 19th at 03:17 pm PST)`

**Line count (including blank lines and compiler line):** `2,099`

**Word count:** `19,862`

**Character count (including spaces):** `134,915`

**Character count (excluding spaces):** `116,470`

**Size (in bytes):** `134,915`
