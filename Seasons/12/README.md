...
| Type rate | Count |
|---|---|
| Success rate (days) | `24` |
| Full success (days) | `9` |
| Partial success (days) | `15` |
| Failure rate (days) | `2` |
| Days passed in season | `26` |
| Days left in season | `04` |
...
| Average length of streak (success) | `8.000 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=7%2C+6%2C+11&x=39&y=18 !-->
...
| Total repository scans | `47,286` |
| Full success % | `034.62%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `057.69%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `092.31%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `007.69%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `27 (2023, Tuesday, June 27th at 01:53 pm PST)`

**Line count (including blank lines and compiler line):** `2,750`

**Word count:** `27,028`

**Character count (including spaces):** `184,645`

**Character count (excluding spaces):** `159,724`

**Size (in bytes):** `184,645`
