...
| Type rate | Count |
|---|---|
| Success rate (days) | `26` |
| Full success (days) | `10` |
| Partial success (days) | `16` |
| Failure rate (days) | `02` |
| Days passed in season | `28` |
| Days left in season | `02` |
| Longest consecutive streak (success) | `13 days` |
| Longest consecutive streak (failure) | `1 day` |
| Last consecutive streak (success) | `13 days` |
...
| Average length of streak (success) | `8.667 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=7%2C+6%2C+13&x=54&y=8 !-->
...
| Total repository scans | `51,836` |
| Full success % | `035.71%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `057.14%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `092.86%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `007.14%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `29 (2023, Thursday, June 29th at 02:25 pm PST)`

**Line count (including blank lines and compiler line):** `2,914`

**Word count:** `28,864`

**Character count (including spaces):** `193,379`

**Character count (excluding spaces):** `170,794`

**Size (in bytes):** `197,379`
