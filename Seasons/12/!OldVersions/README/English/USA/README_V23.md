...
| Type rate | Count |
|---|---|
| Success rate (days) | `20` |
| Full success (days) | `6` |
| Partial success (days) | `14` |
| Failure rate (days) | `2` |
| Days passed in season | `22` |
| Days left in season | `08` |
| Longest consecutive streak (success) | `7 days` |
| Longest consecutive streak (failure) | `1 day` |
| Last consecutive streak (success) | `7 days` |
...
| Average length of streak (success) | `6.667 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=7%2C+6%2C+7&x=84&y=12 !-->
...
| Total repository scans | `35,390` |
| Full success % | `027.27%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `063.64%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `090.91%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `009.09%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `23 (2023, Friday, June 23rd at 02:02 pm PST)`

**Line count (including blank lines and compiler line):** `2,423`

**Word count:** `23,417`

**Character count (including spaces):** `159,599`

**Character count (excluding spaces):** `137,943`

**Size (in bytes):** `159,599`
