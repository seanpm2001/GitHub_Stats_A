...
| Type rate | Count |
|---|---|
| Success rate (days) | `23` |
| Full success (days) | `8` |
| Partial success (days) | `15` |
| Failure rate (days) | `2` |
| Days passed in season | `25` |
| Days left in season | `05` |
| Longest consecutive streak (success) | `10 days` |
| Longest consecutive streak (failure) | `1 day` |
| Last consecutive streak (success) | `10 days` |
...
| Average length of streak (success) | `7.667 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=7%2C+6%2C+10&x=29&y=26 !-->
...
| Total repository scans | `43,648` |
| Full success % | `032.00%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `060.00%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `092.00%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `008.00%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `26 (2023, Monday, June 26th at 03:05 pm PST)`

**Line count (including blank lines and compiler line):** `2,668`

**Word count:** `26,104`

**Character count (including spaces):** `178,261`

**Character count (excluding spaces):** `154,178`

**Size (in bytes):** `178,261`
