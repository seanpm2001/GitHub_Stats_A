...
| Type rate | Count |
|---|---|
| Success rate (days) | `22` |
| Full success (days) | `7` |
| Partial success (days) | `15` |
| Failure rate (days) | `2` |
| Days passed in season | `24` |
| Days left in season | `06` |
| Longest consecutive streak (success) | `9 days` |
| Longest consecutive streak (failure) | `1 day` |
| Last consecutive streak (success) | `9 days` |
...
| Average length of streak (success) | `7.333 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=7%2C+6%2C+9&x=81&y=34 !-->
...
| Total repository scans | `40,016` |
| Full success % | `029.17%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `062.50%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `091.67%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `008.33%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `25 (2023, Sunday, June 25th at 01:40 pm PST)`

**Line count (including blank lines and compiler line):** `2,504`

**Word count:** `25,214`

**Character count (including spaces):** `172,055`

**Character count (excluding spaces):** `148,776`

**Size (in bytes):** `172,055`
...
[`[View this version separately]`](/Seasons/12/!OldVersions/README/English/USA/README_V54.md)
