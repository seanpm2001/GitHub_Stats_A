...
| Type rate | Count |
|---|---|
| Success rate (days) | `21` |
| Full success (days) | `6` |
| Partial success (days) | `15` |
| Failure rate (days) | `2` |
| Days passed in season | `23` |
| Days left in season | `07` |
| Longest consecutive streak (success) | `8 days` |
| Longest consecutive streak (failure) | `1 day` |
| Last consecutive streak (success) | `8 days` |
...
| Average length of streak (success) | `7.000 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=7%2C+6%2C+8&x=61&y=21 !-->
...
| Total repository scans | `36,390` |
| Full success % | `026.09%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `065.22%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `091.30%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `008.70%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `24 (2023, Saturday, June 24th at 04:07 pm PST)`

**Line count (including blank lines and compiler line):** `2,504`

**Word count:** `24,305`

**Character count (including spaces):** `165,763`

**Character count (excluding spaces):** `143,306`

**Size (in bytes):** `165,763`
