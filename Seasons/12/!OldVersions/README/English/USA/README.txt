...
| Average length of streak (success) | `5.000 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=7%2C+6%2C+2&x=49&y=5 !-->
...
| Total repository scans | `25,274` |
| Full success % | `023.53%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `064.71%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `088.24%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `011.76%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `18 (2023, Sunday, June 18th at 04:04 pm PST)`

**Line count (including blank lines and compiler line):** `2,018`

**Word count:** `18,976`

**Character count (including spaces):** `128,759`

**Character count (excluding spaces):** `111,115`

**Size (in bytes):** `128,759`
