...
| Failure rate (days) | `2` |
| Days passed in season | `21` |
| Days left in season | `09` |
...
| Average length of streak (success) | `6333 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=7%2C+6%2C+6&x=53&y=23 !-->
...
| Total repository scans | `31,776` |
| Full success % | `023.81%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `066.67%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `090.48%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `009.52%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `22 (2023, Thursday, June 22nd at 04:06 pm PST)`

**Line count (including blank lines and compiler line):** `2,342`

**Word count:** `22,526`

**Character count (including spaces):** `153,441`

**Character count (excluding spaces):** `132,588`

**Size (in bytes):** `153,441`
