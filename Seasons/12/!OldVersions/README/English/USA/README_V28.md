...
| Type rate | Count |
|---|---|
| Success rate (days) | `25` |
| Full success (days) | `9` |
| Partial success (days) | `16` |
| Failure rate (days) | `2` |
| Days passed in season | `27` |
| Days left in season | `03` |
| Longest consecutive streak (success) | `12 days` |
| Longest consecutive streak (failure) | `1 day` |
| Last consecutive streak (success) | `12 days` |
...
| Average length of streak (success) | `8.333 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=7%2C+6%2C+12&x=41&y=21 !-->
...
| Total repository scans | `48,186` |
| Full success % | `033.33%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `059.26%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `092.59%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `007.41%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `28 (2023, Wednesday, June 28th at 02:49 pm PST)`

**Line count (including blank lines and compiler line):** `2,832`

**Word count:** `27,945`

**Character count (including spaces):** `191,033`

**Character count (excluding spaces):** `165,281`

**Size (in bytes):** `191,033`
