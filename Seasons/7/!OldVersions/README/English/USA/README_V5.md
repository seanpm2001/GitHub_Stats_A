...
The process ran unsuccessfully as usaul today, going into day 19 of a failure streak. The process failed within 0 hours, 1 minute and 18 seconds. There were some `aiohttp` errors, followed by a `AttributeError: 'NoneType' object has no attribute 'get'` error. This error is starting to become very common and may surpass the `Size changed during iteration` error in terms of occurrence.
...
The process ran unsuccessfully as usaul today, going into day 20 of a failure streak. The process failed within 0 hours, 0 minutes and 58 seconds. There were some `aiohttp` errors, followed by a `AttributeError: 'NoneType' object has no attribute 'get'` error. This error is starting to become very common and may surpass the `Size changed during iteration` error in terms of occurrence.
...
**File version:** `5 (2023, Monday, January 9th at 6:53 pm PST)`

**Line count (including blank lines and compiler line):** `809`
