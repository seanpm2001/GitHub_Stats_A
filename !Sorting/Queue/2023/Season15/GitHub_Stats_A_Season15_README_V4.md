...
| Average length of streak (failure) | `1.667 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=2%2C+2%2C+1&x=26&y=16 !-->
| Total repository scans | `8,257` |
| Full success % | `009.09%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `045.45%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `054.54%` | <!-- Formula: Full Success % + Partial Success % !-->
