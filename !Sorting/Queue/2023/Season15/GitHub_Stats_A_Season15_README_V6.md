...
| Average length of streak (success) | `1.500 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=3%2C+1%2C+1%2C+1&x=23&y=10 !-->
...
| Partial success % | `038.46%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `046.15%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.01%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `053.84%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
