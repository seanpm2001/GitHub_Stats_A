...
| Average length of streak (failure) | `1.500 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=2%2C+2%2C+1%2C+1&x=39&y=26 !-->
| Total repository scans | `8,257` |
| Full success % | `008.33%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `041.66%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
