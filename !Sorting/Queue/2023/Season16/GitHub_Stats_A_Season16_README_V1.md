...
| Average length of streak (success) | `0.000 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=0%2C+0&x=46&y=27 !-->
...
| Overall success % | `000.600%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `100.00%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
