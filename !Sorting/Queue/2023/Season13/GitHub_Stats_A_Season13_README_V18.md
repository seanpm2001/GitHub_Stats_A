...
| Average length of streak (success) | `1.375 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=1%2C+1%2C+1%2C+1%2C+1%2C+2%2C+1%2C+3&x=45&y=20 !-->
...
| Total repository scans | `12,045` |
| Full success % | `005.26%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `047.36%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `052.63%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.01%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `047.36%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `18 (2023, Thursday, July 20th at 09:39 am PST)`

**Line count (including blank lines and compiler line):** `2,056`

**Word count:** `21,446`

**Character count (including spaces):** `143,193`

**Character count (excluding spaces):** `123,525`

**Size (in bytes):** `143,193`
