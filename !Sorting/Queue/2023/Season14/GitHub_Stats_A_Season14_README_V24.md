...
The workflow had a partially successful run again today, failing within 1 hour, 20 minutes, and 02 seconds.
...
| Average length of streak (success) | `2.285 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=5%2C+3%2C+2%2C+1%2C+1%2C+3%2C+1&x=35&y=22 !-->
...
| Total repository scans | `16,223` |
| Full success % | `003.70%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `055.55%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `059.25%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.01%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `040.74%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `24 (2023, Monday, August 28th at 03:40 pm PST)`

**Line count (including blank lines and compiler line):** `2,823`

**Word count:** `29,048`

**Character count (including spaces):** `197,612`

**Character count (excluding spaces):** `170,910`

**Size (in bytes):** `197,612`
