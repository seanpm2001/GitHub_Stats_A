...
| Average length of streak (failure) | `1.000 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=1%2C+1&x=33&y=2 !-->
...
| Overall failure % | `016.67%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `11 (2023, Sunday, August 13th at 02:22 pm PST)`

**Line count (including blank lines and compiler line):** `1,458`

**Word count:** `14,375`

**Character count (including spaces):** `97,411`

**Character count (excluding spaces):** `83,978`

**Size (in bytes):** `97,411`
...
[`[View this version separately]`](/Seasons/14/!OldVersions/README/English/USA/README_V101md)
