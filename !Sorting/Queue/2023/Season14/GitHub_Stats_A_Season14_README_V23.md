...
| Total # of streaks (failure) | `6` |
| Average length of streak (success) | `2.500 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=5%2C+3%2C+2%2C+1%2C+1%2C+3&x=43&y=11 !-->
| Average length of streak (failure) | `1.667 days` | <!-- Source: https://www.calculator.net/average-calculator.html?numberinputs=1%2C+1%2C+1%2C+1%2C+4%2C+2&x=31&y=10 !-->
| Total repository scans | `15,423` |
| Full success % | `004.00%` | <!-- Formula: Full Succcess Rate (Days) / Total number of days passed in season !-->
| Partial success % | `056.00%` | <!-- Formula: Partial Succcess Rate (Days) / Total number of days passed in season !-->
| Overall success % | `060.00%` | <!-- Formula: Full Success % + Partial Success % !-->
| Success/failure % Margin of error | `000.00%` | <!-- Formula: Overall success % + Overall failure % = remainder/answer !-->
| Overall failure % | `040.00%` | <!-- Formula: Failure Rate (Days) / Total number of days passed in season !-->
...
**File version:** `23 (2023, Saturday, August 26th at 03:44 pm PST)`

**Line count (including blank lines and compiler line):** `2,658`

**Word count:** `27,210`

**Character count (including spaces):** `185,039`

**Character count (excluding spaces):** `159,962`

**Size (in bytes):** `185,039`
